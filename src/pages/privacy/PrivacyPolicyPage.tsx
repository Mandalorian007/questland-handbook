...
export const PrivacyPolicyPage = () => (
    <div>
        ...
        <ul>
            ...
            <li>
                <p><strong>Website</strong> refers to Questland Handbook, accessible from <a href="https://questland-handbook.com" rel="external nofollow noopener" target="_blank">https://questland-handbook.com</a></p>
            </li>
            <li>
