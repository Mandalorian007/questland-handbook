...
export const PrivacyPolicyPage = () => (
    <div>
        ...
        <h4>Why we have a login feature</h4>
        <div>Logging in with Google was added as a way to help store personalized settings for our users. We added this
            to help provide a higher quality experience and tools that would benefit from remembering where you last
            were.
        </div>
        <h4>What data do we get?</h4>
        <div>When logging in with Google we receive some basic public profile information:</div>
        <ul>
        ...
        <h4>What are we doing with this data?</h4>
        <div>The public profile information will be used to help make a better login experience (ex: showing your
            profile photo badge in the top right for the account options menu)
        </div>
        <div>The only piece of stored information from google is your unique userId. This is what lets us remember who
        ...
        <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the
            ...
            created with the help of the <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/"
                                            target="_blank" rel="noopener noreferrer">Privacy Policy Generator</a>.</p>
        ...
        <ul>
            ...
            <li>
                <p><strong>Website</strong> refers to Questland Handbook, accessible from <a
                    href="https://questland-handbook.com" rel="external nofollow noopener noreferrer"
                    target="_blank">https://questland-handbook.com</a></p>
            </li>
            <li>
        ...
        <p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your
            ...
            close Your web browser. Learn more about cookies: <a href="https://www.freeprivacypolicy.com/blog/cookies/"
                                                                 target="_blank" rel="noopener noreferrer">Cookies: What
                Do They Do?</a>.</p>
        ...
        <ul>
            <li>By email: questland-handbook-security@googlegroups.com</li>
        </ul>
    </div>
);
